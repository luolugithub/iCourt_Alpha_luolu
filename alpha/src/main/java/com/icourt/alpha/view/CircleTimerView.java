...
public class CircleTimerView extends View {
    ...
    private void initialize() {
        ...
        //外边轮廓
        mCircleOutlinePaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mCircleOutlinePaint.setColor(mCircleButtonOutLineColor);
        mCircleOutlinePaint.setStyle(Paint.Style.STROKE);
        mCircleOutlinePaint.setStrokeWidth(mCircleStrokeWidth * 4);
