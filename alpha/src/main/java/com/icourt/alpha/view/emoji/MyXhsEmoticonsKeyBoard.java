 ...
 * version 1.0.0
 */
public class MyXhsEmoticonsKeyBoard extends sj.keyboard.widget.AutoHeightLayout implements android.view.View.OnClickListener, sj.keyboard.widget.EmoticonsFuncView.OnEmoticonsPageViewListener, sj.keyboard.widget.EmoticonsToolBarView.OnToolBarItemClickListener, sj.keyboard.widget.EmoticonsEditText.OnBackKeyClickListener, sj.keyboard.widget.FuncLayout.OnFuncChangeListener {
    ...
    public MyXhsEmoticonsKeyBoard(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void inflateKeyboardBar() {
        mInflater.inflate(R.layout.my_view_keyboard_xhs, this);
    }
