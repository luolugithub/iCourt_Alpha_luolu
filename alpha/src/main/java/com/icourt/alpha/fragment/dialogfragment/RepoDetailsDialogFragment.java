        ...
        switch (repoType) {
            case REPO_MINE:
                baseFragmentAdapter.bindTitle(true, Arrays.asList(
                        getString(R.string.repo_change_history),
                        getString(R.string.repo_inner_share),
                        getString(R.string.repo_recycle_bin)));
            ...
            case REPO_SHARED_ME:
                ...
                break;
            case REPO_LAWFIRM:
                baseFragmentAdapter.bindTitle(true, Arrays.asList(getContextString(R.string.repo_recycle_bin)));
                baseFragmentAdapter.bindData(true,
