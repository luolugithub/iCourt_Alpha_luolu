...
public class TimingMonthListFragment extends BaseFragment {
    ...
    public static TimingMonthListFragment newInstance(long startTimeMillis) {
        TimingMonthListFragment fragment = new TimingMonthListFragment();
