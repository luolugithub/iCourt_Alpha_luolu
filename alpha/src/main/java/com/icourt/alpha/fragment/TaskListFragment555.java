...
public class TaskListFragment555 extends BaseTaskFragment implements
        TaskAdapter555.OnShowFragmenDialogListener,
        TaskAdapter555.OnUpdateNewTaskCountListener,
    ...
    public static TaskListFragment555 newInstance(int type, int stateType) {
        TaskListFragment555 projectTaskFragment = new TaskListFragment555();
    ...
    protected void initView() {
        ...
        if (stateType == 0) {//未完成
            ...
            taskAdapter555.setDeleteTask(true);
            taskAdapter555.setEditTask(true);
            taskAdapter555.setAddTime(true);
            taskAdapter555.setOnShowFragmenDialogListener(this);
            taskAdapter555.setOnUpdateNewTaskCountListener(this);
...
//                        onTasksChangeListener.onTasksChanged(response.body().result.items);
    ...
    private int getParentPositon(String taskId) {
        if (taskAdapter555 == null) return -1;
    ...
    private RecyclerView getChildRecyclerView(String taskId) {
        if (taskAdapter555 == null) return null;
