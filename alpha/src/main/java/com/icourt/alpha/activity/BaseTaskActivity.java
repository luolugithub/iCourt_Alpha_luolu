...
public abstract class BaseTaskActivity extends BaseActivity implements OnFragmentCallBackListener, ProjectSelectDialogFragment.OnProjectTaskGroupSelectListener{
    /**
     * 编辑任务权限
     */
